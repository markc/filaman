...
namespace FilaMan\PagesPlugin\Tests\Unit;

use FilaMan\PagesPlugin\Services\PageDiscoveryService;
...
class PageDiscoveryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->testPagesPath = base_path('packages/pages-plugin/resources/views/pages');
    }
