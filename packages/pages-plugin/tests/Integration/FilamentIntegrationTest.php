...
namespace FilaMan\PagesPlugin\Tests\Integration;

use App\Models\User;
use FilaMan\PagesPlugin\PagesPlugin;
use Filament\Panel;
...
class FilamentIntegrationTest extends TestCase
{
    ...
    public function test_filaman_plugin_path_helper()
    {
        ...
        $this->assertStringContainsString('packages/pages-plugin/resources/views', $path);
